...
exports.getFoundationSkills = getFoundationSkills;
/**
...
function getAllSkillIds() {
    return Object.keys(exports.SKILLS);
}
/**
 * Get skill definition by ID
 */
function getSkill(skillId) {
    return exports.SKILLS[skillId];
}
/**
 * Get skills by category
 */
function getSkillsByCategory(category) {
    return Object.values(exports.SKILLS).filter(skill => skill.category === category);
}
/**
 * Get foundation skills (no prerequisites)
 */
function getFoundationSkills() {
    return Object.values(exports.SKILLS).filter(skill => skill.prerequisites.length === 0);
}
